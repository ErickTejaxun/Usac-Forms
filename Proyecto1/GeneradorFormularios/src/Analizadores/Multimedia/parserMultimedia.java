...
public class parserMultimedia implements parserMultimediaConstants {
  ...
  final public Nodo Inicio() throws ParseException {Nodo nuevo = new Nodo("multimedia","multimedia",0,0);
    Nodo aux = null;
    Token t1= null;
    Token t2=null;
    ...
    case media_audio:{
      switch ((jj_ntk==-1)?jj_ntk_f():jj_ntk) {
      case media_video:{
        t1 = jj_consume_token(media_video);
        break;
        }
      case media_audio:{
        t1 = jj_consume_token(media_audio);
        break;
        }
      default:
        jj_la1[0] = jj_gen;
...
nuevo.setValue(t1.image);
    ...
    case media_imagen:{
      t1 = jj_consume_token(media_imagen);
      t2 = jj_consume_token(cadena);
nuevo.setValue(t1.image);
        nuevo.add(new Nodo("path",t2.image,t2.beginColumn, t2.beginLine));
       {if ("" != null) return nuevo;}
  ...
  final public Nodo Rep() throws ParseException {Nodo nuevo = null;
    Token t = null;
    t = jj_consume_token(reproduccion);
  ...
  private boolean jj_3R_15()
 {
  ...
  static {
   ...
   private static void jj_la1_init_0() {
      jj_la1_0 = new int[] {0x0,0x0,0x0,0x8010000,0x30060000,0xa00000,0x7000000,0x80dc1c,};
   }
   private static void jj_la1_init_1() {
      jj_la1_1 = new int[] {0x30,0x240,0x38,0x0,0x0,0x0,0x0,0x303,};
   }
