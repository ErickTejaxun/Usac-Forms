...
public class parserCodigo implements parserCodigoConstants {
    ...
    public static Nodo main(String args[], int row, int column) throws ParseException
    {
        if(args.length>0)      
        {
            ...
            parserCodigo analizador = new parserCodigo(data);
        ...
        else
        {
            try
            {
                parserCodigo analizador = new parserCodigo(System.in);
                analizador.Etiqueta();
            }
...
ArrayList<Nodo> hijos = new ArrayList();
    ...
    default:
      jj_la1[1] = jj_gen;
{if ("" != null) return new Nodo("codigo","codigo",0,0);}
    }
  ...
  final public Nodo ETQ() throws ParseException {String Cad;
    ...
    izquierda = T();
    derecha = ETQ2();
nuevo = new Nodo("codigo","codigo",0,0);
...
nuevo = new Nodo("cadena","#"+t.image, t.beginColumn, t.beginLine);
  ...
  static {
   ...
   private static void jj_la1_init_0() {
      jj_la1_0 = new int[] {0xc4,0xc4,0xc5,0xc4,0x48,};
   }
