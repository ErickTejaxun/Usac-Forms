/* parserPredeterminado.java */
/* Generated By:JavaCC: Do not edit this line. parserPredeterminado.java */
...
public class parserPredeterminado implements parserPredeterminadoConstants {
        public int row;
    public int column;
    public static Nodo main(String args[], int row, int column) throws ParseException
    {
        if(args.length>0)      
        {
            ...
            parserPredeterminado analizador = new parserPredeterminado(data);
        ...
        else
        {
            try
            {
                parserPredeterminado analizador = new parserPredeterminado(System.in);
                analizador.Inicio();
            }
  ...
  final public Nodo Inicio() throws ParseException {Nodo aux = new Nodo("predeterminado","predeterminado",0,0);
    Nodo nuevo = null;
    Token t= null;
    nuevo = logica();
    jj_consume_token(0);
...
nuevo = new Nodo("expr","expr",t.beginColumn, t.beginLine);
  ...
  private boolean jj_3_2()
 {
  ...
  public parserPredeterminadoTokenManager token_source;
  ...
  static {
   ...
   private static void jj_la1_init_0() {
      jj_la1_0 = new int[] {0x10020000,0x600c0000,0x1400000,0xe000000,0x101b89c,};
   }
   private static void jj_la1_init_1() {
      jj_la1_1 = new int[] {0x0,0x0,0x0,0x0,0x66,};
   }
  ...
  public parserPredeterminado(java.io.InputStream stream) {
     this(stream, null);
  }
  /** Constructor with InputStream and supplied encoding */
  public parserPredeterminado(java.io.InputStream stream, String encoding) {
    try { jj_input_stream = new SimpleCharStream(stream, encoding, 1, 1); } catch(java.io.UnsupportedEncodingException e) { throw new RuntimeException(e); }
    token_source = new parserPredeterminadoTokenManager(jj_input_stream);
    token = new Token();
    jj_ntk = -1;
    jj_gen = 0;
  ...
  /** Constructor. */
  public parserPredeterminado(java.io.Reader stream) {
  ...
  public parserPredeterminado(parserPredeterminadoTokenManager tm) {
    token_source = tm;
    token = new Token();
    jj_ntk = -1;
    jj_gen = 0;
  ...
  /** Reinitialise. */
  public void ReInit(parserPredeterminadoTokenManager tm) {
    token_source = tm;
    token = new Token();
    jj_ntk = -1;
    jj_gen = 0;
