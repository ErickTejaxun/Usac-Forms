/* parserRepeticion.java */
/* Generated By:JavaCC: Do not edit this line. parserRepeticion.java */
package Analizadores.Repeticion;
import AST.Nodo;
import java.io.ByteArrayInputStream;
import java.io.InputStream;
import java.util.ArrayList;

public class parserRepeticion implements parserRepeticionConstants {
    public static Nodo main(String args[]) throws ParseException
    {
        if(args.length>0)
        {
            ...
            parserRepeticion analizador = new parserRepeticion(data);
        ...
        else
        {
            try
            {
                parserRepeticion analizador = new parserRepeticion(System.in);
                analizador.Inicio();
            }
...
nuevo = new Nodo("expr","expr",t.beginColumn, t.beginLine);
  ...
  private boolean jj_3R_9()
 {
  ...
  public parserRepeticionTokenManager token_source;
  ...
  static {
   ...
   private static void jj_la1_init_0() {
      jj_la1_0 = new int[] {0x40080000,0x80300000,0x5000000,0x38000000,0x406e29c,};
   }
   private static void jj_la1_init_1() {
      jj_la1_1 = new int[] {0x0,0x1,0x0,0x0,0x198,};
   }
  ...
  public parserRepeticion(java.io.InputStream stream) {
     this(stream, null);
  }
  /** Constructor with InputStream and supplied encoding */
  public parserRepeticion(java.io.InputStream stream, String encoding) {
    try { jj_input_stream = new SimpleCharStream(stream, encoding, 1, 1); } catch(java.io.UnsupportedEncodingException e) { throw new RuntimeException(e); }
    token_source = new parserRepeticionTokenManager(jj_input_stream);
    token = new Token();
    jj_ntk = -1;
    jj_gen = 0;
  ...
  /** Constructor. */
  public parserRepeticion(java.io.Reader stream) {
  ...
  public parserRepeticion(parserRepeticionTokenManager tm) {
    token_source = tm;
    token = new Token();
    jj_ntk = -1;
    jj_gen = 0;
  ...
  /** Reinitialise. */
  public void ReInit(parserRepeticionTokenManager tm) {
    token_source = tm;
    token = new Token();
    jj_ntk = -1;
    jj_gen = 0;
