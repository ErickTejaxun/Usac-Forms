/* parserRestringir.java */
/* Generated By:JavaCC: Do not edit this line. parserRestringir.java */
...
public class parserRestringir implements parserRestringirConstants {
        public int row;
    public int column;
    public static Nodo main(String args[], int row, int column) throws ParseException
    {
        if(args.length>0)      
        {
            ...
            parserRestringir analizador = new parserRestringir(data);
        ...
        else
        {
            try
            {
                parserRestringir analizador = new parserRestringir(System.in);
                analizador.Inicio();
            }
  ...
  final public Nodo Inicio() throws ParseException {Nodo aux = new Nodo("restringir","restringir",0,0);
    Nodo nuevo = null;
    Token t= null;
    nuevo = logica();
    jj_consume_token(0);
...
if(auxiliar!=null)
            {
                ...
                for(Nodo nod: auxiliar.getHijos()){nuevo.add(nod);}
                {if ("" != null) return nuevo;}
            }
            {if ("" != null) return new Nodo("funcion",t.image,t.beginColumn, t.beginLine);}
      break;
      }
    default:
      jj_la1[5] = jj_gen;
  ...
  final public Nodo listaParametros() throws ParseException {Nodo izquierdo = null;
    Nodo nuevo =  new Nodo("parametros","parametros",0,0);
    Nodo derecho = null;
    Token t = null;
    izquierdo = logica();
    label_8:
...
nuevo.addI(izquierdo);
  ...
  private boolean jj_3R_10()
 {
  ...
  public parserRestringirTokenManager token_source;
  ...
  static {
   ...
   private static void jj_la1_init_0() {
      jj_la1_0 = new int[] {0x40080000,0x80300000,0x5000000,0x38000000,0x406e29c,0x406e29c,};
   }
   private static void jj_la1_init_1() {
      jj_la1_1 = new int[] {0x0,0x1,0x0,0x0,0x358,0x358,};
   }
  ...
  public parserRestringir(java.io.InputStream stream) {
     this(stream, null);
  }
  /** Constructor with InputStream and supplied encoding */
  public parserRestringir(java.io.InputStream stream, String encoding) {
    try { jj_input_stream = new SimpleCharStream(stream, encoding, 1, 1); } catch(java.io.UnsupportedEncodingException e) { throw new RuntimeException(e); }
    token_source = new parserRestringirTokenManager(jj_input_stream);
    token = new Token();
    jj_ntk = -1;
    jj_gen = 0;
  ...
  /** Constructor. */
  public parserRestringir(java.io.Reader stream) {
  ...
  public parserRestringir(parserRestringirTokenManager tm) {
    token_source = tm;
    token = new Token();
    jj_ntk = -1;
    jj_gen = 0;
  ...
  /** Reinitialise. */
  public void ReInit(parserRestringirTokenManager tm) {
    token_source = tm;
    token = new Token();
    jj_ntk = -1;
    jj_gen = 0;
